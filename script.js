...
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFoYW96bmt1ZHVzYWp0emFfbG9jYWwiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc3NTIzNDQ1MSwiZXhwIjoyMDkwODEwNDUxfQ.RbMEdiLooCsDKefdXnM_0jse63_C4sl1tWQ5BfWVU1s'; // Menggunakan key dari codingan Anda
...
function updateDashboard(data) {
    ...
    // MODIFIKASI DISINI: Kirim data riil nominal rupiah s.cash dan s.leas agar grafik donut valid
...
// MODIFIKASI DISINI: Menerima nominal riil rupiah untuk dirender secara akurat ke grafik donut
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Live Sync Realtime bawaan Anda tetap utuh
    supabase
