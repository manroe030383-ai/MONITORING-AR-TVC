...
function renderDataArUnitFull(data) {
    ...
    targetElement.innerHTML = filteredData.map((d, i) => {
        ...
        <tr class="hover:bg-slate-50/80 transition-all font-bold uppercase whitespace-nowrap">
            ...
            <td class="p-3"><input type="text" id="input-plan-${idRow}" class="input-custom" value="${currentPlan}" placeholder="Isi plan..."></td>
            <td class="p-3"><input type="text" id="input-ket-${idRow}" class="input-custom" value="${currentKet}" placeholder="Isi keterangan..."></td>
            <td class="p-3"><input type="text" id="input-cabang-${idRow}" class="input-custom" value="${currentCabang}" placeholder="Ket cabang..."></td>
