...
// ==========================================
// 5. RENDER GRAFIK & LIST (UPDATE: DISABLE DATALABELS)
// ==========================================
function renderCharts(cash, leasing, agingData) {
    ...
    donutChart = new ApexCharts(document.querySelector("#chart-donut-main"), {
        ...
        // Menonaktifkan angka/persentase di dalam lingkaran
        dataLabels: { 
            enabled: false 
        }
    });
    ...
    barChart = new ApexCharts(document.querySelector("#chart-aging-nominal"), {
        ...
        // Menonaktifkan angka nominal di atas batang
        dataLabels: { 
            enabled: false 
        }
    });
...
setInterval(loadData, 300000);import { createClient } from 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm'
